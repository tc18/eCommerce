                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search Offer</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <c:forEach items="${sessionScope.offer}" var="i">
                                        	<tr>
                                        		<td>${i.offerId}</td>
                                    			...
                                    			<td>${i.offerDateFrom}</td>
                                    			<td>${i.offerDateTo}</td>
                                    			<td><a href="<%=request.getContextPath() %>/OfferController?flag=edit&id=${i.offerId}"><button type="button" class="btn btn-primary">Edit</button></a></td>
                                    			<td><a href="<%=request.getContextPath() %>/OfferController?flag=delete&id=${i.offerId}"><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    	</c:forEach>
										</tbody>
										</table>
