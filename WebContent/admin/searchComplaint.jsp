                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search Complaint</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>ComplaintReply</th>
                                                <th>Reply</th>
                                                <th>Delete</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${sessionScope.complaint}" var="i">
                                        	<tr>
                                    			<td>${i.complaintId}</td>
                                    			<td>${i.complaintName}</td>
                                    			<td>${i.complaintDescription}</td>
                                    			<td>${i.complaintTo}</td>
                                    			<td>${i.complaintFrom}</td>
                                    			<td>${i.complaintDate}</td>
                                    			<td>${i.complaintTime}</td>
                                    			<td>${i.complaintStatus}</td>
                                    			<td>${i.complaintReply}</td>
                                    			<td><a href=<%=request.getContextPath() %>/ComplaintController?flag=reply&id=${i.complaintId}><button type="button" class="btn btn-primary">Reply</button></a></td>
                                    			<td><a href=<%=request.getContextPath() %>/ComplaintController?flag=delete&id=${i.complaintId}><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    	</c:forEach>
										</tbody>
										</table>
