...
<html lang="en">
    ...
    <head>
        ...
        <link href="css/default/style.min.css" rel="stylesheet" type="text/css" />
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>Tree View
                                <small>customizable fuelux tree view</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
...
<![endif]-->
        ...
        <script src="js/ui-tree.min.js" type="text/javascript"></script>
