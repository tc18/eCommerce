                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search Tips Type</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        ...
                                        <c:forEach items="${sessionScope.tipsType}" var="i">
                                        	<tr>
                                    			<td>${i.tipsTypeName}</td>
                                    			<td>${i.tipsTypeName}</td>
                                    			<td>${i.tipsTypeDescription}</td>
                                    			<td><a href=<%=request.getContextPath() %>/TipsTypeController?flag=edit&id=${i.tipsTypeId}><button type="button" class="btn btn-primary">Edit</button></a></td>
                                    			<td><a href=<%=request.getContextPath() %>/TipsTypeController?flag=delete&id=${i.tipsTypeId}><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    	</c:forEach>
										</tbody>
										</table>
