                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search Feedback</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <c:forEach items="${sessionScope.feedback}" var="i">
                                        	<tr>
                                    			<td>${i.feedbackId}</td>
                                    			<td>${i.feedbackName}</td>
                                    			<td>${i.feedbackDescription}</td>
                                    			<td>${i.ratingName}</td>
                                    			<td>${i.feedbackFrom}</td>
                                    			<td>${i.feedbackDate}</td>
                                    			<td>${i.feedbackTime}</td>
                                    			<td><a href=<%=request.getContextPath() %>/FeedbackController?flag=delete&id=${i.feedbackId}><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    	</c:forEach>
										</tbody>
										</table>
