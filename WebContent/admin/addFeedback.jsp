...
<link rel="stylesheet" href="css/bootstrap.min1.css" rel="stylesheet">
<link rel="stylesheet" href="css/font-awesome.min1.css">
<link rel="stylesheet" href="css/star-rating1.css" media="all"
	rel="stylesheet" type="text/css" />
<script src="js/jquery.min1.js"></script>
<script src="js/star-rating1.js" type="text/javascript"></script>
...
<script>
	...
	function validate() {
		...
		xmlhttp
				.open(
						"get",
						"${pageContext.request.contextPath}/FeedbackController?flag=validate&feedbackName="
								+ feedbackName.value, true);
		xmlhttp.send();
	}
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<form action="<%=request.getContextPath()%>/FeedbackController"
									onsubmit="return returnValidate()" id="form_sample_1"
									...
									<div class="form-body">
										...
										<div class="form-group">
											<label class="control-label col-md-3">Rating <span
												class="required"> * </span>
											</label>
											<div class="col-md-4">
												<!-- 												<select class="form-control" id="ratingName" -->
												<!-- 													name="ratingName" required=""> -->
												...
												<!-- 												</select> -->
												<input id="input-21d" name="ratingName" value="0" type="number" class="rating"
													min=0 max=5 step=0.5 data -size="sm">
											</div>
										</div>

										<div class="form-group">
											<label class="control-label col-md-3">Feedback <span
												class="required"> * </span>
											</label>
											<div class="col-md-4">
												<input type="text" name="feedbackName" id="feedbackName"
													required="" onblur="validate()" data-required="1"
													class="form-control" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<textarea class="form-control" name="feedbackDescription"></textarea>
											</div>
										</div>
