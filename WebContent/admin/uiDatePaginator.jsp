...
<html lang="en">
    ...
    <head>
        ...
        <link href="css/bootstrap-datepaginator.min.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <script src="js/bootstrap-datepaginator.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="js/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="js/ui-datepaginator.min.js" type="text/javascript"></script>
