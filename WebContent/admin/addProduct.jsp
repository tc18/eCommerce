...
<script>
	function loadSize() {
		...
		if (id == 1) {
			...
			newCheckBox.setAttribute("id", "ch1");
			var newlabel = document.createElement("label");
			newlabel.setAttribute("for", "ch1");
			newlabel.setAttribute("style", "margin-right:5px");
			...
			newCheckBox.setAttribute("type", "checkbox");
			newCheckBox.setAttribute("name", "sizeName");
			newCheckBox.setAttribute("id", "ch2");
			newCheckBox.setAttribute("value", "S");
			var newlabel = document.createElement("label");
			newlabel.setAttribute("for", "ch2");
			newlabel.setAttribute("style", "margin-right:5px");
			...
			newCheckBox.setAttribute("type", "checkbox");
			newCheckBox.setAttribute("name", "sizeName");
			newCheckBox.setAttribute("id", "ch3");
			newCheckBox.setAttribute("value", "M");
			var newlabel = document.createElement("label");
			newlabel.setAttribute("for", "ch3");
			newlabel.setAttribute("style", "margin-right:5px");
			...
			newCheckBox.setAttribute("type", "checkbox");
			newCheckBox.setAttribute("name", "sizeName");
			newCheckBox.setAttribute("id", "ch4");
			newCheckBox.setAttribute("value", "L");
			var newlabel = document.createElement("label");
			newlabel.setAttribute("for", "ch4");
			newlabel.setAttribute("style", "margin-right:5px");
			...
			newCheckBox.setAttribute("type", "checkbox");
			newCheckBox.setAttribute("name", "sizeName");
			newCheckBox.setAttribute("id", "ch5");
			newCheckBox.setAttribute("value", "XL");
			var newlabel = document.createElement("label");
			newlabel.setAttribute("for", "ch5");
			newlabel.setAttribute("style", "margin-right:5px");
			...
			newCheckBox.setAttribute("type", "checkbox");
			newCheckBox.setAttribute("name", "sizeName");
			newCheckBox.setAttribute("id", "ch6");
			newCheckBox.setAttribute("value", "XXL");
			var newlabel = document.createElement("label");
			newlabel.setAttribute("for", "ch6");
			newlabel.setAttribute("style", "margin-right:5px");
			...
			newCheckBox.setAttribute("id", "ch7");
			var newlabel = document.createElement("label");
			newlabel.setAttribute("for", "ch7");
			newlabel.setAttribute("style", "margin-right:5px");
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for (i = 0; i < jsonObj.length; i++) {
					...
					createOption.value = jsonObj[i].categoryId;
					createOption.text = jsonObj[i].categoryName;
								...
								<form action="<%=request.getContextPath()%>/ProductController"
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="price" id="price" data-required="1"
													class="form-control" required="" />
											</div>
										</div>
										<div class="form-group">
