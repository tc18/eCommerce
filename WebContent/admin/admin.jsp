		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<ul class="page-breadcrumb breadcrumb">
					<li><a href="<%=request.getContextPath()%>/admin/admin.jsp">Home</a>
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="dashboard-stat blue">
							...
							<div class="details">
								<div class="number">
									<%
										...
										List ls = loginDAO.search("FeedbackVO");
									%>

									<span data-counter="counterup" data-value="<%=ls.size()%>">
							...
							<a class="more"
								href="<%=request.getContextPath()%>/admin/searchFeedback.jsp">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="dashboard-stat green">
							...
							<div class="details">
								<div class="number">
									<%
										ls = loginDAO.search("ProductVO");
									%>

									<span data-counter="counterup" data-value="<%=ls.size()%>"></span>
								</div>
								<div class="desc">New Products</div>
							</div>
							<a class="more"
								href="<%=request.getContextPath()%>/admin/searchProduct.jsp">
								View more <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="dashboard-stat purple">
							...
							<div class="details">
								<div class="number">
									<%
										ls = loginDAO.search("ComplaintVO");
									%>
									<span data-counter="counterup" data-value="<%=ls.size()%>"></span>
								</div>
								<div class="desc">New Complaints</div>
							</div>
							<a class="more"
								href="<%=request.getContextPath()%>/admin/searchComplaint.jsp">
								View more <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
