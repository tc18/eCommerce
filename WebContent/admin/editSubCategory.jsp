...
<script>
	...
	function validate() {
		...
		xmlhttp
				.open(
						"get",
						"${pageContext.request.contextPath}/SubCategoryController?flag=validate&subCategoryName="
								+ subCategoryName.value, true);
		xmlhttp.send();
	}
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<c:forEach items="${sessionScope.editSubCategory}" var="i">
									<form
										action="<%=request.getContextPath()%>/SubCategoryController"
										 id="form_sample_1"
										...
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<input type="text" onblur="validate()" id="subCategoryName"
														name="subCategoryName" required=""
														value="${i.subCategoryName }" data-required="1"
														class="form-control" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<textarea class="form-control"
														name="subCategoryDescription">${i.subCategoryDescription}</textarea>
												</div>
											</div>
