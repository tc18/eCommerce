                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search Country</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        ...
                                        <c:forEach items="${sessionScope.country}" var="i">
                                        	<tr>
                                    			...
                                    			<td><a href=<%=request.getContextPath() %>/CountryController?flag=edit&id=${i.countryId}><button type="button" class="btn btn-primary">Edit</button></a></td>
                                    			<td><a href=<%=request.getContextPath() %>/CountryController?flag=delete&id=${i.countryId}><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    	</c:forEach>
										</tbody>
										</table>
