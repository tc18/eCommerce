            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="<%=request.getContextPath()%>/admin/admin.jsp">
                        <img src="img/bg.png" style="width:135px; height:50px" alt="logo" class="logo-default" /> </a>
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <span class="username username-hide-on-mobile"> Nirali </span>
                                    <!-- DOC: Do not remove below empty space(&nbsp;) as its purposely used -->
                                    <img alt="" class="img-circle" src="img/nirali.jpg" /> </a>
