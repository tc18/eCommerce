                                    ...
                                    <form action="<%=request.getContextPath() %>/CityController" onsubmit="return returnValidate()" name="cityForm" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="cityName" id="cityName" data-required="1" required="" onblur="validate()" class="form-control" />
...
<!--                                             	<div class="col-md-4"> -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <textarea class="form-control" name="cityDescription"></textarea></div>
                                            </div> 
                                            <div class="col-md-4">
