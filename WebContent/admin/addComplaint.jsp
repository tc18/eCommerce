...
<html lang="en">
	...
	function validate()
	{
		...
		xmlhttp.open("get", "${pageContext.request.contextPath}/ComplaintController?flag=validate&complaintName="+complaintName.value, true);
		xmlhttp.send();	
	}
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Add Complaint</span>
                                    </div>
                                    
                                </div>
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="<%=request.getContextPath() %>/ComplaintController" onsubmit="return returnValidate()" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="complaintName" id="complaintName" required="" onblur="validate()" data-required="1" class="form-control" /> </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <textarea class="form-control" name="complaintDescription"></textarea></div>
                                            </div>
