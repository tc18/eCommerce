  ...
  function loadSubCategory()
	{
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) 
			{
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					document.productForm.subCategoryId.options.add(createOption);
		...
		xmlhttp.open("get", "${pageContext.request.contextPath}/ProductController?flag=loadingSubCategory&categoryId="+categoryId.value, true);
		xmlhttp.send();
	...
	{	
		...
		xmlhttp.open("GET","${pageContext.request.contextPath}/ProductController?flag=validate&productName="+productName.value, true);
		xmlhttp.send();	
	}
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								...
								<form action="<%=request.getContextPath() %>/ProductController"
									 name="productForm"
									id="form_sample_1" class="form-horizontal" onsubmit="return returnValidate()" method="post">
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="productName" id="productName"
													 data-required="1" onblur="return validate()" class="form-control"
													required="" />
											</div>
