                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Add Tips</span>
                                    </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <c:forEach items="${sessionScope.tipsType}" var="i">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="tipsName" id="tipsName" required="" onblur="validate()" data-required="1" class="form-control" /> </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <textarea class="form-control" name="tipsDescription"></textarea></div>
                                            </div>
                                        </div>
