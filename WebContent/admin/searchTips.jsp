                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search Tips</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        <thead>
                                            <tr>
                                            	...
                                            	<th>TipsTypeName</th>
                                                <th>TipsName</th>
                                                <th>TipsDescription</th>
                                                <th>Edit</th>
                                                <th>Delete</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${sessionScope.tips}" var="i">
                                        	<tr>
                                        		<td>${i.tipsId}</td>
                                        		<td>${i.tipsTypeVO.tipsTypeName}</td>
                                    			<td>${i.tipsName}</td>
                                    			<td>${i.tipsDescription}</td>
                                    			<td><a href=<%=request.getContextPath() %>/TipsController?flag=edit&id=${i.tipsId}><button type="button" class="btn btn-primary">Edit</button></a></td>
                                    			<td><a href=<%=request.getContextPath() %>/TipsController?flag=delete&id=${i.tipsId}><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    	</c:forEach>
										</tbody>
										</table>
