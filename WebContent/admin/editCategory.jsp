...
<script>
	...
	function validate() {
		...
		xmlhttp
				.open(
						"get",
						"${pageContext.request.contextPath}/CategoryController?flag=validate&categoryName="
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<c:forEach items="${sessionScope.editCategory}" var="i">
									<form action="<%=request.getContextPath()%>/CategoryController"
										...
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<input type="text" id="categoryName" name="categoryName"
														onblur="validate()" required="" data-required="1"
														class="form-control" value="${i.categoryName}" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<textarea class="form-control" name="categoryDescription">${i.categoryDescription}</textarea>
												</div>
											</div>
