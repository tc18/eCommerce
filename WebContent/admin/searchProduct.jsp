							...
							<div class="portlet-title">
								<div class="caption font-dark">
									<i class="icon-settings font-dark"></i> <span
										class="caption-subject bold uppercase">Search Product</span>
								</div>
								<div class="tools"></div>
							</div>
									...
									<tbody>
										<c:forEach items="${sessionScope.product}" var="i">
											<tr>
												...
												<td>${i.sizeName}</td>
												<td>${i.colorVO.colorName}</td>
												<td>${i.productName}</td>
												<td>${i.productDescription}</td>
												<td>${i.price}</td>
												<td><a
													href="<%=request.getContextPath() %>/ProductController?flag=edit&id=${i.productId}"><button
															type="button" class="btn btn-primary">Edit</button></a></td>
												<td><a
													href="<%=request.getContextPath() %>/ProductController?flag=delete&id=${i.productId}"><button
...
<![endif]-->
	...
	<script src="js/table-datatables-scroller.min.js"
