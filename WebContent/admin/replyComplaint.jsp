...
<script>
	var temp = "false";
	function validate() {
		var complaintName = document.getElementById("complaintName");
		...
		xmlhttp
				.open(
						"get",
						"${pageContext.request.contextPath}/ComplaintController?flag=validate&complaintName="
								+ complaintName.value, true);
		xmlhttp.send();
	}
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-settings font-red"></i> <span
										class="caption-subject font-red sbold uppercase">Reply
										Complaint</span>
								</div>
								<div class="actions">
							...
							<div class="portlet-body">
								...
								<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
								<form
									action="<%=request.getContextPath()%>/ComplaintController"
									id="form_sample_1" class="form-horizontal" method="post">
									<c:forEach items="${sessionScope.replyList }" var="i">
										...
										<div class="form-body">
											...
											<!--                                                 <label class="control-label col-md-3">Complaint Reply -->
											<!--                                                     <span class="required"> * </span> -->
											<!--                                                 </label> -->
											<!--                                                 <div class="col-md-4"> -->
											<!--                                                     <input type="text" name="complaintRepl" id="complaintName" required="" onblur="validate()" data-required="1" class="form-control" /> </div> -->
											<!--                                             		<span id="span1" style="display:none">Error</span> -->
											<!--                                             </div> -->

											<div class="form-group">
												<label class="control-label col-md-3">Complaint
													Reply <span class="required"> * </span>
												</label>
												<div class="col-md-4">
													<textarea class="form-control" name="complaintReply"></textarea>
												</div>
											</div>
										</div>
										<input type="hidden" name="complaintId" value="${i.complaintId }">
										<input type="hidden" name="complaintName" value="${i.complaintName }">
										<input type="hidden" name="complaintDescription" value="${i.complaintDescription }">
										<input type="hidden" name="complaintDate" value="${i.complaintDate }">
										<input type="hidden" name="complaintTime" value="${i.complaintTime }">
										<input type="hidden" name="complaintTo" value="${i.complaintTo }">
										<input type="hidden" name="complaintFrom" value="${i.complaintFrom }">
										<div class="form-actions">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													<button type="submit" class="btn green">Reply</button>
													<input type="hidden" name="flag" value="replied">
