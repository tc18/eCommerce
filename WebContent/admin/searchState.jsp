                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search State</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        ...
                                        <c:forEach items="${sessionScope.state}" var="i">
                                        	<tr>
                                    			...
                                    			<td><a href=<%=request.getContextPath() %>/StateController?flag=edit&id=${i.stateId}><button type="button" class="btn btn-primary">Edit</button></a></td>
                                    			<td><a href=<%=request.getContextPath() %>/StateController?flag=delete&id=${i.stateId}><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    	</c:forEach>
										</tbody>
										</table>
