                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search City</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        	<c:forEach items="${sessionScope.city}" var="i">
                                        	<tr>
                                        		<td>${i.cityId}</td>
                                    			...
                                    			<td><a href=<%=request.getContextPath() %>/CityController?flag=edit&id=${i.cityId}><button type="button" class="btn btn-primary">Edit</button></a></td>
                                    			<td><a href=<%=request.getContextPath() %>/CityController?flag=delete&id=${i.cityId}><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    		</c:forEach>														
										</tbody>
										</table>
