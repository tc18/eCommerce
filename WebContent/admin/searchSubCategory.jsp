                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Search Sub Category</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <c:forEach items="${sessionScope.subCategory}" var="i">
                                        	<tr>
                                        		<td>${i.subCategoryId}</td>
                                        		<td>${i.mainTypeVO.mainTypeName}</td>
                                        		<td>${i.categoryVO.categoryName}</td>
                                    			<td>${i.subCategoryName}</td>
                                    			<td>${i.subCategoryDescription}</td>
                                    			<td><a href=<%=request.getContextPath() %>/SubCategoryController?flag=edit&id=${i.subCategoryId}><button type="button" class="btn btn-primary">Edit</button></a></td>
                                    			<td><a href=<%=request.getContextPath() %>/SubCategoryController?flag=delete&id=${i.subCategoryId}><button type="button" class="btn btn-danger">Delete</button></a></td>
                                    		</tr>
                                    	</c:forEach>
