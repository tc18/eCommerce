...
<script>
	function loadSubCategory() {
		...
		xmlhttp.open("get","${pageContext.request.contextPath}/OfferController?flag=loadingSubCategory&categoryId="+categoryId.value, true);
		xmlhttp.send();
		/* jQuery(".chosen-select1").chosen({'width':'100%','white-space':'nowrap'}); */
		/* Holds the status of the XMLHttpRequest. Changes from 0 to 4:
			0: request not initialized
	...
	function loadProduct() {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for (i = 0; i < jsonObj.length; i++) {
					var createOption = document.createElement("option");
					createOption.value = jsonObj[i].productId;
					createOption.text = jsonObj[i].productName;
							...
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-settings font-red"></i> <span
										class="caption-subject font-red sbold uppercase">Add
										Offers</span>
								</div>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<select class="form-control" id="mainTypeId"
													...
													<c:forEach items="${sessionScope.mainTypeList}" var="j">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<select class="form-control" id="categoryId"
													name="categoryId" required="" onchange="loadSubCategory()">
													<option value="0">Select...</option>
...
<%-- 													</c:forEach> --%>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<select class="form-control" id="subCategoryId" name="subCategoryId" required="" onchange="loadProduct()">
													<option value="0">Select...</option>
												</select>
											</div>
										</div>
										...
										<!--                                                 </label> -->
										<!--                                                 <div class="col-md-4"> -->
										<!--                                                     <input type="text" name="productName" data-required="1" class="form-control" /> </div> -->
										<!--                                             </div> -->
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<textarea class="form-control" name="offerDescription"></textarea>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="date" name="offerDateFrom" data-required="1"
