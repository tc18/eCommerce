...
<html lang="en">
	...
	function validate()
	{
		...
		xmlhttp.open("get", "${pageContext.request.contextPath}/StateController?flag=validate&stateName="+stateName.value, true);
		xmlhttp.send();	
	}
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Add State</span>
                                    </div>
                                    
                                </div>
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="<%=request.getContextPath()%>/StateController" onsubmit="return returnValidate()" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="stateName" id="stateName" onblur="validate()" data-required="1" required="" class="form-control" /> </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <textarea class="form-control" name="stateDescription"></textarea></div>
                                            </div>
