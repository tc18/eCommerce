							...
							<div class="portlet-title">
								<div class="caption font-dark">
									<i class="icon-settings font-dark"></i> <span
										class="caption-subject bold uppercase">Search Main Type</span>
								</div>
								<div class="tools"></div>
							</div>
								...
								<table
									...
									<tbody>
										<c:forEach items="${sessionScope.mainTypeList}" var="i">
											<tr>
												<td>${i.mainTypeId}</td>
												<td>${i.mainTypeName}</td>
<!-- 												<td><a -->
<%-- 													href="<%=request.getContextPath() %>/MainTypeController?flag=edit&id=${i.mainTypeId}"><button --%>
<!-- 															type="button" class="btn btn-primary">Edit</button></a></td> -->
												<td><a
													href="<%=request.getContextPath() %>/MainTypeController?flag=delete&id=${i.mainTypeId}"><button
