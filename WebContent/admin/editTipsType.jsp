...
<script>
	...
	function validate() {
		...
		xmlhttp
				.open(
						"get",
						"${pageContext.request.contextPath}/TipsTypeController?flag=validate&tipsTypeName="
								+ tipsTypeName.value, true);
		xmlhttp.send();
	}
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<c:forEach items="${sessionScope.editTipsType }" var="i">
									<form
										action="<%=request.getContextPath()%>/TipsTypeController"
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="control-label col-md-3">Tips Type <span
													class="required"> * </span>
												</label>
												<div class="col-md-4">
													<input type="text" name="tipsTypeName" id="tipsTypeName"
														required="" onblur="validate()" data-required="1"
														class="form-control" value="${i.tipsTypeName }"/>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<textarea class="form-control" name="tipsTypeDescription">${i.tipsTypeDescription}</textarea>
												</div>
											</div>

										</div>
										<input type="hidden" name="tipsTypeId" value="${i.tipsTypeId }">
