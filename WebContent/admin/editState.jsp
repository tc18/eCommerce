...
<script>
	...
	function validate() {
		...
		xmlhttp.open("get",
				"${pageContext.request.contextPath}/StateController?flag=validate&stateName="
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								...
								<c:forEach items="${sessionScope.editState }" var="i">
									<form action="<%=request.getContextPath()%>/StateController"
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<select class="form-control" name="countryId" required="">
														...
														<%--                                                     <c:forEach items="${sessionScope.loadCountry}" var="i"> --%>
...
<%-- 											<c:forEach items="${sessionScope.editState}" var="j"> --%>
												<div class="form-group">
													<label class="control-label col-md-3">State Name <span
														class="required"> * </span>
													</label>
													<div class="col-md-4">
														<input type="text" onblur="validate()" id="stateName"
															name="stateName" data-required="1" required=""
															class="form-control" value="${i.stateName}" />
													</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<textarea class="form-control" name="stateDescription">${i.stateDescription}</textarea>
													</div>
												</div>
