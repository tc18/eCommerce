                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Add Country</span>
                                    </div>
                                    ...
                                    <form action="<%=request.getContextPath()%>/CountryController" onsubmit="return returnValidate()" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="countryName" id="countryName" onblur="validate()" data-required="1" class="form-control" required=""/> </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <textarea class="form-control" name="countryDescription"></textarea></div>
                                            </div>
