...
<html lang="en">
	...
	function validate()
	{
		...
		xmlhttp.open("get", "${pageContext.request.contextPath}/CountryController?flag=validate&countryName="+countryName.value, true);
		xmlhttp.send();	
	}
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Edit Country</span>
                                    </div>
                                    
                                </div>
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="<%=request.getContextPath()%>/CountryController" onsubmit="return returnValidate()" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
                                            <div class="alert alert-danger display-hide">
                                                <button class="close" data-close="alert"></button> You have some form errors. Please check below. </div>
                                            <div class="alert alert-success display-hide">
                                                <button class="close" data-close="alert"></button> Your form validation is successful! </div>
                                            <c:forEach items="${sessionScope.editCountry}" var="j">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Country Name
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <input type="text" onblur="validate()" id="countryName" name="countryName" required="" data-required="1" value="${j.countryName}" class="form-control" /> </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <textarea class="form-control" name="countryDescription">${j.countryDescription}</textarea></div>
                                            </div>
                                            <input type="hidden" name="countryId" value="${j.countryId }">
                                            </c:forEach>
