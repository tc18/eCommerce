...
<script>
	function loadCategory() {
		...
		xmlhttp
				.open(
						"get",
						"${pageContext.request.contextPath}/OfferController?flag=loadingCategory&mainTypeId="
...
<script>
	function loadSubCategory() {
		...
		var subCategory = document.getElementById("hdnsubCategory1");
		var xmlhttp;
		...
		xmlhttp
				.open(
						"get",
						"${pageContext.request.contextPath}/OfferController?flag=loadingSubCategory&categoryId="
				...
				<div class="page-head">
					...
					<div class="page-toolbar">
						<div id="dashboard-report-range"
							...
							data-placement="top"
							data-original-title="Change da<foshboard date range">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<select class="form-control" id="mainTypeId"
														name="mainTypeId" required="" onchange="loadCategory()">
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													<input type="hidden" id="category1"
														value="${i.categoryVO.categoryId}" /> <input type="hidden"
														id="hdnsubCategory1"
														value="${i.subCategoryVO.subCategoryId }" /> <input
														type="hidden" id="product1"
														value="${i.productVO.productId }" />
