...
String gt1 = request.getParameter("gt1");
session.setAttribute("gtotal1", gt1);
				...
				<div class="main">
					<div class="col-main">
						...
						<a class="opc-back-to back-to"
							href="http://milano.shopshark.eu/checkout/cart/">Return to
							Cart</a>
						...
						<ol class="opc" id="checkoutSteps">
							<li id="opc-login" class="section allow">
								...
								<div id="checkout-step-login" class="step a-item"
									style="display: none;">
									<form
										action="<%=request.getContextPath()%>/UserRegisterController" method="post"
										id="form-validate">
										<div class="fieldset">
											<input type="hidden" name="success_url"/> <input
												type="hidden" name="error_url" />
											<h2 class="legend">Personal Information</h2>
											<ul class="form-list">
												<li><label for="email_address" class="required"><em>*</em>Reciever's Name</label>
													<div class="input-box">
														<input type="text" name="rName" title="Reciever's Name" class="input-text required-entry" />
													</div></li>
												<li><label for="email_address" class="required"><em>*</em>Contact Number</label>
													<div class="input-box">
														<input type="text" name="contact"
															title="Contact Number" class="input-text required-entry" />
													</div></li>
												...
												<li><label for="email_address" class="required"><em>*</em>City</label>
													<div class="input-box">
														<input type="text" name="cityName" id="email_address"
															title="City" class="input-text required-entry" />
													</div></li>
												<li><label for="email_address" class="required"><em>*</em>Country
												</label>
													<div class="input-box">
														<select name="countryName" id="email_address"
													...
													<div class="field">
														...
														<div class="input-box">
															<input type="text" name="emailId" id="emailId"
																...
																class="input-text validate-email required-entry" /> <span
																id="span1" style="display: none">Enter Valid
																E-mail Address</span>
														</div>
													</div>
													<div class="field">
										...
										<div class="buttons-set">
											...
											<input type="hidden" name="flag" value="onepage"/> 
											<input type="submit" title="Submit" value="Submit" id="myBtn"
												class="button"></input>
										</div>
									</form>
